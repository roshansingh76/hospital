			...
			{flagMobilecontainer &&
				<div className="form-new-pop">
					...
					<div className="from-right">
					  ...
					  {loader &&
						<img style={{ height: '25px',width: '25px' }} alt="" src="data:image/gif;base64," />
						}
						{error &&
