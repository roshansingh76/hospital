...
const TalkastrologerAstologerdetails = () => (
		<TAstologerdetails/>		
				...
				<div className="col-md-12">
					<div className="j-astro-profile">
						<div className="profile-pic-j">
							<img src="https://www.jyotirvid.in/assets/img/user_imgs/1516254127.png" alt="image" />
						</div>
						<div className="profile-info-j">
							...
							<div className="a-pro-btn">
								...
								<span className="btn-wa"><a href="#"><span className="fa fa-phone-square"></span> Call Request</a></span>
								<span className="btn-suc"><a href="astrloger-book.html" ><span className="glyphicon glyphicon-calendar"></span> Book Appointment</a></span>
							</div>
