...
class Callingpack extends Component {
  ...
  async componentDidMount() {
    try {
      const apiUrl = `${url}/api/user/getUserDetails?id=${localStorage.getItem(
        "id"
      )}`;
                ...
                {packList.length > 1 &&
                  packList.map((rowData, index) => (
                    <div key={index + 1} className="col-md-6">
                      <a
                        onClick={e =>
                          this.checkPrice(rowData.id, rowData.price)
                        }
                      >
                        <div
                          className={
                            rowData.id == packId
                              ? "asto-package-price active"
                              : "asto-package-price"
                          }
                        >
                          <p>
                            {rowData.price} <i className="fa fa-inr"></i>
                          </p>
                          <span>Add money</span>
                        </div>
                      </a>
                      ...
                      <tr className="cart_item cart_totle">
                        ...
                        <td className="cart-product-name">
                          <span className="amount">
                            {currentPrice} <i className="fa fa-inr"></i>
                          </span>
                        </td>
                      </tr>
                      <tr className="cart_item cart_totle">
